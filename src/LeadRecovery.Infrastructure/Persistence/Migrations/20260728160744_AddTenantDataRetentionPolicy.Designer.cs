...
namespace LeadRecovery.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260728160744_AddTenantDataRetentionPolicy")]
    partial class AddTenantDataRetentionPolicy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeadRecovery.Domain.Analysis.AiAnalysis", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("ExtractedPreferredCallbackWindow")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                    ...
                    b.Property<string>("RawStructuredOutputJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                    ...
                    b.Property<string>("ReviewedCategory")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("reviewed_category");

                    b.Property<string>("ReviewedCity")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("reviewed_city");

                    b.Property<string>("ReviewedPostalCode")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("reviewed_postal_code");

                    b.Property<string>("ReviewedPreferredCallbackWindow")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("reviewed_preferred_callback_window");

                    b.Property<string>("ReviewedSuggestedReply")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("reviewed_suggested_reply");

                    b.Property<string>("ReviewedSummary")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("reviewed_summary");

                    b.Property<string>("ReviewedUrgency")
                        .HasMaxLength(32)
                    ...
                    b.Property<string>("UrgencySuggestion")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                    ...
                    b.HasIndex("TenantId", "ReviewedByUserId")
                        .HasDatabaseName("ix_ai_analyses_tenant_reviewer");

                    b.HasIndex("TenantId", "LeadId", "ReviewStatus", "CreatedAtUtc")
                        .HasDatabaseName("ix_ai_analyses_tenant_lead_review_created");

                    b.HasIndex("TenantId", "LeadId", "SchemaVersion", "InputHash")
                        .IsUnique()
                        .HasDatabaseName("ux_ai_analyses_tenant_lead_schema_input_hash");

                    b.ToTable("ai_analyses", null, t =>
                        {
                            t.HasCheckConstraint("ck_ai_analyses_confidence", "confidence >= 0 and confidence <= 1");

                            t.HasCheckConstraint("ck_ai_analyses_review_metadata", "(review_status = 'Pending' and reviewed_by_user_id is null and reviewed_at_utc is null)\nor\n(review_status <> 'Pending' and reviewed_by_user_id is not null and reviewed_at_utc is not null)");

                            t.HasCheckConstraint("ck_ai_analyses_review_status", "review_status in ('Pending', 'Accepted', 'Edited', 'Rejected')");

                            t.HasCheckConstraint("ck_ai_analyses_review_values", "(review_status in ('Accepted', 'Edited') and reviewed_category is not null and reviewed_urgency is not null and reviewed_summary is not null)\nor\n(review_status in ('Pending', 'Rejected') and reviewed_category is null and reviewed_urgency is null and reviewed_summary is null)");

                            t.HasCheckConstraint("ck_ai_analyses_reviewed_urgency", "reviewed_urgency is null or reviewed_urgency in ('Unknown', 'Low', 'Normal', 'High', 'CriticalReview')");

                            t.HasCheckConstraint("ck_ai_analyses_urgency_suggestion", "urgency_suggestion in ('Unknown', 'Low', 'Normal', 'High', 'CriticalReview')");
                        });
                });
            ...
            modelBuilder.Entity("LeadRecovery.Domain.Tenancy.Tenant", b =>
                {
                    ...
                    b.Property<bool>("DataRetentionEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.ToTable("tenants", null, t =>
                        {
                            t.HasCheckConstraint("ck_tenants_data_retention_days", "data_retention_days between 30 and 3650");
            ...
            modelBuilder.Entity("LeadRecovery.Domain.Analysis.AiAnalysis", b =>
                {
                    ...
                    b.HasOne("LeadRecovery.Domain.Identity.TenantMembership", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "ReviewedByUserId")
                        .HasPrincipalKey("TenantId", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ai_analyses_memberships_tenant_id_reviewed_by_user_id");
                });
