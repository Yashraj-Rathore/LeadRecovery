...
using LeadRecovery.Infrastructure.Onboarding;
...
using LeadRecovery.Infrastructure.Persistence.Reporting;
...
public static class DependencyInjection
{
        ...
        LeadAnalysisWorkflowOptions? analysisOptions = null)
    {
        ...
        services.AddSingleton<IOnboardingSecretSource, EnvironmentOnboardingSecretSource>();
        services.AddScoped<TenantOnboardingUseCase>();
        services.AddScoped<IPilotReportStore, PilotReportStore>();
        services.AddScoped<PilotReportUseCase>();
